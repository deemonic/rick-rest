...
<template>
    ...
    <div class="min-h-screen max-h-screen background">
        ...
        <div class="max-w-2xl mx-auto mt-5 text-center">
            ...
            <p class="text-xl font-semibold">A free rest api for random Rick and Morty quotes</p>
        ...
        <div class="max-w-2xl mx-auto mt-10">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="/api/getQuote" class="flex bg-white px-3 py-2 rounded-md items-center">
                ...
                <div class="flex space-x-2">
                    ...
                    <a id="tweetLink" class="flex items-center bg-blue-300 hover:bg-blue-400 px-4 uppercase py-2 text-white rounded-md font-semibold text-xs" data-size="large" target="_blank">
            ...
            <!-- Quote Container -->
            <div class="mt-5 bg-gradient-to-l from-lime-400 to-indigo-600 rounded-3xl p-6 shadow-2xl shadow-lime-400/50">

                <div class="w-full px-12 py-6 bg-white rounded-xl shadow-2xl shadow-lime-400/50">
